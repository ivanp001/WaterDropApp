...
2. On Customers list page can be seen all customers after creating, without any acton available:
...
3. In Customers Details can be created new Customers:
...
4. In Values List can be seen all values for the customer
